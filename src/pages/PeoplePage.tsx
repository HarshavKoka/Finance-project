...
const PeoplePage = () => {
  ...
  const group =
    (searchParams.get("group") as "IncomeTax" | "GST" | "MCA") || "IncomeTax";
    ...
    <div className="flex flex-col items-end space-y-5">
      ...
      {showInfo && group === "IncomeTax" && (
        <div className="mt-4 p-4 border rounded bg-gray-50 space-y-3">
          ...
          <p>
           There are different
            types of ITR forms based on income sources and taxpayer categories.
            For example, ITR-1 (Sahaj) is for individuals with salary or pension
            income, ITR-2 is for those with income from multiple sources like
            property or capital gains, ITR-3 for professionals or business
            owners, and ITR-4 (Sugam) for small businesses under presumptive
            taxation. Higher categories like ITR-5, ITR-6, and ITR-7 are meant
            for firms, companies, and charitable trusts. Choosing the right form
            is crucial, as filing with the wrong one can lead to rejection. 
          </p>
          <p>The
            deadlines for ITR filing vary depending on the taxpayer. Generally,
            for individuals and salaried employees, the due date is 31st July of
            the assessment year. For companies and taxpayers requiring audit,
            the deadline is usually 31st October, while those involved in
            transfer pricing transactions may get time until 30th November. The
            government sometimes extends these dates depending on circumstances,
            but filing after the deadline attracts late fees, interest, and
            sometimes penalties. </p>
            <p>As for who should file ITR, it applies to
            individuals, Hindu Undivided Families (HUFs), firms, companies, and
            trusts whose income is above the exemption limit. Currently, the
            basic exemption limit is ₹2.5 lakh for individuals below 60 years,
            ₹3 lakh for senior citizens (60–80 years), and ₹5 lakh for super
            senior citizens (above 80 years). Apart from income criteria, filing
            is also mandatory if someone wants to claim a refund, carry forward
            losses, or has foreign assets. Thus, ITR filing is not just a duty
            but also a way to stay compliant and financially transparent.</p>
        </div>
      )}
